...
const innovationCourse: NewCourse = {
...
const allCourses: NewCourse[] = [aiCourse, apiDevelopmentCourse, apisAndBackendCourse, cybersecurityCourse, techLeadershipCourse, researchInTechnologyCourse, innovationCourse];
