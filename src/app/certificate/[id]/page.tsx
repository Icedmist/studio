...
const QrCodePlaceholder = () => (
  <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-foreground">
    <path fillRule="evenodd" clipRule="evenodd" d="M0 0H40V40H0V0ZM10 10V30H30V10H10Z" fill="currentColor"/>
    <path fillRule="evenodd" clipRule="evenodd" d="M60 0H100V40H60V0ZM70 10V30H90V10H70Z" fill="currentColor"/>
    <path fillRule="evenodd" clipRule="evenodd" d="M0 60H40V100H0V60ZM10 70V90H30V70H10Z" fill="currentColor"/>
